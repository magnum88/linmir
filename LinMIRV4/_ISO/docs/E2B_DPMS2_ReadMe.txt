...
If this is not done, the internal hard disk(s) will not be listed by XP setup. See www.easy2boot.com for more details.

 o  E2B+DPMS download already includes the Mass Storage Driver Pack (no action is required)
 o  E2B      download does not include Mass Storage Driver Pack (follow instructions below)

To add XP auto-driver detection to E2B:
...
\_ISO\e2b\grub\DPMS\D                   empty folder (only contains M folder)
...
The files dir0.txt and dir1.txt will contain directory listings of the two virtual F6 floppies.
...
Donations for this software can be made via PayPal - please visit the www.easy2boot.com website to make a donation if you enjoy using this software!
